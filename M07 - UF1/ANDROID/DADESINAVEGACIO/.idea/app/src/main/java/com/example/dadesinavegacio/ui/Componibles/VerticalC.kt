...
@Composable
fun ComponibleVerticalC(consert: Consert,onPantallaDetalladaC: (Int) -> Unit= {}) {
    Box() {
        Column(
            modifier = Modifier
                .padding(10.dp)
                .clickable(onClick = {onPantallaDetalladaC(consert.id)})
                .wrapContentHeight()
                .fillMaxWidth()
            ...
            Row(
                ...
                Text(
                    text = "Descripció: ${consert.descripcio}",
                    style = MaterialTheme.typography.labelSmall,
