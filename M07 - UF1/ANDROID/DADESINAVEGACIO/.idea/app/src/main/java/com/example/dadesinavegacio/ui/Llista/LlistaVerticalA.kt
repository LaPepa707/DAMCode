...
@Composable
fun LlistaVerticalA(artistes : List<Artista> = Artistes.obtenDadesDelsArtistes(), onClickElement: (Int) -> Unit = {}) {
    LazyColumn(
        modifier = Modifier
        ...
        items(artistes){art ->
            ComponibleVerticalA(art, onPantallaDetalladaA = {onClickElement(art.id)})
        }
    }
}