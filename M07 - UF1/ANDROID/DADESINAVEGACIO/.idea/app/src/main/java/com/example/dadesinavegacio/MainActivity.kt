...
import com.example.dadesinavegacio.Navegacio.CategoriaArtistes
import com.example.dadesinavegacio.Navegacio.GrafNavegacio
import com.example.dadesinavegacio.Navegacio.MenuArtiste
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                ...
                navigationIcon = {
                    if(destinacioActual?.hasRoute(MenuArtiste::class) != false)
                        IconButton(onClick = {})
                        {
                            Icon(
