...
@Composable
fun ComponibleVerticalA(artista: Artista,onPantallaDetalladaA:(Int)-> Unit= {}) {
    Box() {
        Column(
            modifier = Modifier
                .padding(10.dp)
                .clickable(onClick = {onPantallaDetalladaA(artista.id)})
                .wrapContentHeight()
                .fillMaxWidth()
            ...
            Row(
                ...
                Text(
                    text = "Integrants: ${artista.integrants}",
                    style = MaterialTheme.typography.labelSmall,
                    modifier = Modifier.weight(0.5f).padding(5.dp),
                    color = Color.Black
                )
            ...
            Row(
                ...
                Text(
                    text = "Descripció: ${artista.descripcio}",
                    style = MaterialTheme.typography.labelSmall,
