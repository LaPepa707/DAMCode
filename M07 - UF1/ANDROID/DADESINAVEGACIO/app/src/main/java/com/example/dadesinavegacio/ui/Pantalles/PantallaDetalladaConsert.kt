...
@Preview
@Composable
fun PantallaDetalladaC(consert: Consert = Conserts.obtenirConsert())
{
            ...
            Row(modifier = Modifier
                ...
                Column(//col1
                    ...
                    Row(modifier = Modifier
                        ...
                        Text(text = "DESCRIPCIÓ: ${consert.descripcio}", modifier = Modifier
                            .padding(7.dp),
                            style = MaterialTheme.typography.labelSmall)
                    }
                }
                Column(//col2
                    ...
                    Row(modifier = Modifier
                        ...
                        Text(text = "ARTISTA: ${consert.artista.nom}", modifier = Modifier
                            .padding(7.dp),
                            style = MaterialTheme.typography.labelSmall)
                    }
                }
